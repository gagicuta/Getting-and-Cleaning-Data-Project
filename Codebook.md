...
README.txt includes background information on this data set.
...
Prior to normalization, acceleration measurements (variables containing Accelerometer) were made in g's and gyroscope measurements (variables containing Gyroscope) were made in radians per second.
